...
func NewZabbixMysql(ctx context.Context) (Zabbix, error) {
	...
	_, err = zabbix.getZabbixMysqlDBContainer(ctx)
	if err != nil {
		return nil, fmt.Errorf("failed to get zabbix DB container, err: %s", err.Error())
	}

	_, err = zabbix.getZabbixMysqlServerContainer(ctx)
	if err != nil {
...
func (z *ZabbixMysql) getZabbixMysqlDBContainer(ctx context.Context) (testcontainers.Container, error) {
	z.DBPort = "5432"
...
func (z *ZabbixMysql) getZabbixMysqlServerContainer(ctx context.Context) (testcontainers.Container, error) {
...
func (z *ZabbixMysql) GetServerHost() string {
	return z.ServerHost
}

func (z *ZabbixMysql) GetServerPort() string {
	return z.ServerPort
}
