...
func (t *Ticket_template) New_testcase(testcase_id uint, testcase_description string) *TestCase {
...
func (t *Ticket_template) Add_testcase(tc *TestCase) {
	t.Testcases = append(t.Testcases, *tc)
}

func (t *Ticket_template) Get_testcases() []TestCase {
	return t.Testcases
}
